          ...
          <div class="flex items-start md:items-center flex-shrink-0 text-white mr-6 flex-col sm:flex-row">
            <a href="#">
              <div class="text-gray-800 no-underline font-bold">
                <span class="text-md sm:pl-2 flex items-center">Book Land</span>
              </div>
            </a>
        ...
        <div class="mx-5 my-16 md:my-24 sm:grid grid-cols-2 gap-5 justify-items-center md:max-w-3xl md:mx-auto md:mt-24 md:mb-24">
          <div class="text-center bg-white shadow-lg md:max-w-sm">
            <div class="px-7 py-9">
              ...
              <p>
                The books are organized by author, genre, theme and year of
                publication. Users can search for specific books or browse the
                different book categories to find what they are looking for.
              </p>
              <button class="bg-transparent border-gray-700 border-2 text-gray-800 font-bold uppercase py-2 px-7 mt-7 rounded-full inline-block sm:mt-8 text-xs tracking-wider hover:bg-gray-700 hover:text-white">
                purchase now
              </button>
            </div>

            <img
              src="https://i.pinimg.com/originals/5d/f4/f3/5df4f3e9b7fe009090507697635e286a.jpg"
          ...
          <div class="text-center bg-white shadow-lg md:max-w-sm">
            ...
            <img
              src="https://i.pinimg.com/originals/8e/b7/ca/8eb7ca42fb8b4927d9801694bd1a3eae.jpg"
              alt="Spring collection"
              class="h-56 object-cover w-full md:h-64"
            />
          </div>
